...
#define STATUS2_PASSABLE              (STATUS2_CONFUSION | STATUS2_CONFUSION_TURN | STATUS2_FOCUS_ENERGY | STATUS2_WRAPPED | STATUS2_WRAPPED_TURN | STATUS2_ESCAPE_PREVENTION | STATUS2_CURSED | STATUS2_SUBSTITUTE)
...
#define STATUS3_MUDSPORT                (1 << 16) //unused
#define STATUS3_WATERSPORT              (1 << 17) //unused
#define STATUS3_UNDERWATER              (1 << 18)
#define STATUS3_INTIMIDATE_POKES        (1 << 19)
#define STATUS3_TRACE                   (1 << 20)
#define STATUS3_SEMI_INVULNERABLE       (STATUS3_UNDERGROUND | STATUS3_ON_AIR | STATUS3_UNDERWATER)
#define STATUS3_PASSABLE                (STATUS3_PERISH_SONG | STATUS3_ROOTED | STATUS3_LEECHSEED_BATTLER | STATUS3_LEECHSEED)
