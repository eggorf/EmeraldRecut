...
const u32 gMonStillFrontPic_Dudunsparce[] = INCBIN_U32("graphics/pokemon/Dudunsparce/front.4bpp.lz");
...
const u32 gMonStillFrontPic_Porygon_Z[] = INCBIN_U32("graphics/pokemon/Porygon_Z/front.4bpp.lz");
