const struct BattleFrontierTrainer gBattleFrontierTrainers[FRONTIER_TRAINERS_COUNT] =
{
    ...
    [FRONTIER_TRAINER_PIERCE] = {
        ...
        .speechLose = {EC_WORD_DIDN_T, EC_WORD_IT, EC_MOVE(SNOWSCAPE), EC_WORD_TOO, EC_WORD_QUES, EC_EMPTY_WORD},
    ...
    [FRONTIER_TRAINER_MELODY] = {
        ...
        .speechLose = {EC_WORD_THE, EC_WORD_FORECAST, EC_WORD_SAYS, EC_WORD_IT, EC_WORD_WILL, EC_MOVE(SNOWSCAPE)},
    ...
    [FRONTIER_TRAINER_BRYON] = {
        .facilityClass = FACILITY_CLASS_COOLTRAINER_M,
        .trainerName = _("BRYON"),
        .speechBefore = {EC_WORD_MY, EC_WORD_WILL, EC_MOVE2(SLAM), EC_WORD_YOU, EC_WORD_EXCL},
