...
const u8 gText_1200CoinsAndPrice[] = _("1200 COINS ¥10,000");
...
const u8 gText_BeautySpace[] = _("Beauty ");
...
const u8 gText_DreamEater16BP[] = _("DREAM EATER{CLEAR_TO 0x4E}16BP");
const u8 gText_WillOWisp24BP[] = _("WILL-O-WISP{CLEAR_TO 0x4E}24BP");
...
const u8 gText_Confirm[] = _("CONFIRM");
...
ALIGNED(4) const u8 gText_Exit2[] = _("EXIT");
